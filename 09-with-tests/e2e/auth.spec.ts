...
test.describe('Authentication Flow (Unauthenticated)', () => {
  ...
  test('should not show New Article button when not authenticated', async ({ page }) => {
    await page.goto('/');
  ...
  test('should navigate to Stack auth when clicking sign in', async ({ page }) => {
    await page.goto('/');
  ...
  test('should navigate to Stack auth when clicking sign up', async ({ page }) => {
    await page.goto('/');
  ...
  test('should allow viewing articles without authentication', async ({ page }) => {
    await page.goto('/');
  ...
  test('should allow viewing individual articles without authentication', async ({ page }) => {
    await page.goto('/');
